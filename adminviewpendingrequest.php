    ...
    <body>
        ...
        <div class="sidebar">
            <ul class="nav-links">
                ...
                <li><a href="adminviewapplications.php" class="active">All pending Applications</a></li>
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<tr>
                                ...
                                <td>
                                    <button class='action-btn delete-btn' onclick=\"if(confirm('Delete this application?')) window.location.href='admindeleteapplication.php?id={$row['id']}';\">Delete</button>
                                </td>
                              </tr>";
                    }
                    echo "</table>";
