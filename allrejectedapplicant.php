...
if (isset($_SESSION["username"])) {
    ...
    // Fetch all declined applications
    $sql = "SELECT * FROM declined_application ORDER BY id DESC";
    ...
    <head>
        <meta charset="UTF-8">
        <title>JFS - Declined Applications</title>
    ...
    <body>
        ...
        <div class="sidebar">
            <ul class="nav-links">
                ...
                <li><a href="allacceptedapplicant.php">Accepted Applications</a></li>
                <li><a href="allrejectedapplicant.php" class="active">Declined Applications</a></li>
            </ul>
        </div>
        ...
        <div class="main-content">
            <div class="content">
                <h2>All Declined Job Applications</h2>
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<tr>
                                ...
                                <td>" . date("d-m-Y", strtotime($row['rejected_at'])) . "</td>
                                <td><a href='uploads/{$row['cv']}' target='_blank'>View CV</a></td>
                                <td>
                                    <button class='action-btn delete-btn' onclick=\"if(confirm('Delete this declined application?')) window.location.href='admindeletedeclinedapplication.php?id={$row['id']}';\" style='background-color:red;color:white;'>Delete</button>
                                </td>
                              </tr>";
                    }
                    ...
                    echo "<p style='text-align:center;font-size:1.3rem;'>No declined applications found.</p>";
                }
                ?>
            </div>
        </div>
